...
export default class NotifService {
  ...
  createDefaultChannels() {
    PushNotification.createChannel(
      {
        channelId: '@string/arsh1', // (required)
        channelName: `@string/arseesha`, // (required)
    ...
    PushNotification.createChannel(
      {
        channelId: '@string/sound1', // (required)
        channelName: `@string/areeshaaa`, // (required)
  ...
  createOrUpdateChannel() {
    ...
    PushNotification.createChannel(
      {
        channelId: '@string/anzzz', // (required)
        channelName: `@string/bol: ${this.lastChannelCounter}`, // (required)
  ...
  localNotif(soundName) {
    ...
    PushNotification.localNotification({
      ...
      channelId: soundName ? '@string/arsh1' : '@string/sound1',
